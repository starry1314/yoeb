...
print("[装备拾取] 已启用分阶段白装拾取 (1-10级:1洞 / 11-30级:2洞 / 含战杖)")
...
g_shengHuaJob="暴徒"
--SetUseWeapon(str)--设置使用的武器 支持(盾}箭袋}爪}匕首|战杖|单手剑|细剑|单手斧|单手锤|符文匕首|短杖|战杖|弓|长杖|双手剑|双手斧|双手锤) 如果需要用两样中间用|分开
SetUseWeapon("战杖|盾")
...
--pos=部位支持部位 支持(戒指|项链|腰带|鞋子|手套|衣服|头盔|盾|箭袋|爪}匕首|战杖|单手剑|细剑|单手斧|单手锤|符文匕首|短杖|战杖|弓|长杖|双手剑|双手斧|双手锤) 不填或nil为设置所有
...
--pos 部位 支持(戒指|项链|腰带|鞋子|手套|衣服|头盔|盾|箭袋|爪}匕首|战杖|单手剑|细剑|单手斧|单手锤|符文匕首|短杖|战杖|弓|长杖|双手剑|双手斧|双手锤) 可填多个，中间用|隔开
...
SetAtuoChangeEquipData("暗影|野蛮人|决斗者|野蛮人|游侠|圣堂武僧","战杖","life_reserved_by_stat_%",-99999)--减分 冥约
...
SetAtuoChangeEquipData("暗影|野蛮人|决斗者|野蛮人|游侠|圣堂武僧","战杖","minion_damage_+%",10,1)                                    --召唤伤害基底
SetAtuoChangeEquipData("暗影|野蛮人|决斗者|野蛮人|游侠|圣堂武僧","战杖","minion_attack_and_cast_speed_+%",5,1)                      --后缀施法速度
...
SetAtuoChangeEquipData("暗影|野蛮人|决斗者|野蛮人|游侠|圣堂武僧","鞋子|手套|头盔|衣服|盾|战杖","总洞",30,1)                        --每加1孔加50点比重
SetAtuoChangeEquipData("暗影|野蛮人|决斗者|野蛮人|游侠|圣堂武僧","鞋子|手套|头盔|衣服|盾|战杖","连洞",30,1)                        --每連1孔加40点比重
...
SetAtuoChangeEquipData("暗影|野蛮人|决斗者|野蛮人|游侠|圣堂武僧","战杖","minion_critical_strike_multiplier_+",30,2)               --召唤暴击加成
SetAtuoChangeEquipData("暗影|野蛮人|决斗者|野蛮人|游侠|圣堂武僧","战杖","minion_critical_strike_chance_+%",30,2)                  --召唤暴击
SetAtuoChangeEquipData("暗影|野蛮人|决斗者|野蛮人|游侠|圣堂武僧","战杖","minion_attack_and_cast_speed_+%",40,2)                  --召唤攻擊和施放速度
SetAtuoChangeEquipData("暗影|野蛮人|决斗者|野蛮人|游侠|圣堂武僧","战杖","minion_damage_+%",45,2)                                 --召唤伤害
SetAtuoChangeEquipData("暗影|野蛮人|决斗者|野蛮人|游侠|圣堂武僧","战杖","spell_skill_gem_level_+%",100,2)                        --全部法术等级+1
SetAtuoChangeEquipData("暗影|野蛮人|决斗者|野蛮人|游侠|圣堂武僧","战杖","minion_skill_gem_level_+%",120,2)                        --召唤物等级+1
...
-- 战杖 - 召唤物生存与输出
SetAtuoChangeEquipData("野蛮人","战杖","minion_maximum_life_+%",35,2)                -- 召唤生命
SetAtuoChangeEquipData("野蛮人","战杖","minion_life_regeneration_rate_per_minute_%",18,2) -- 召唤回复
SetAtuoChangeEquipData("野蛮人","战杖","minion_accuracy_rating_+%",20,2)             -- 召唤命中
...
-- 战杖法术评分
SetAtuoChangeEquipData("野蛮人","战杖","spell_damage_+%",25,2)                       -- 法术伤害
SetAtuoChangeEquipData("野蛮人","战杖","base_cast_speed_+%",22,2)                    -- 施法速度
SetAtuoChangeEquipData("野蛮人","战杖","spell_critical_strike_chance_+%",18,2)       -- 法术爆击
SetAtuoChangeEquipData("野蛮人","战杖","spell_critical_strike_multiplier_+",18,2)    -- 法术爆击伤
SetAtuoChangeEquipData("野蛮人","战杖","fire_damage_+%",15,2)                        -- 火焰伤害
SetAtuoChangeEquipData("野蛮人","战杖","lightning_damage_+%",15,2)                   -- 闪电伤害
SetAtuoChangeEquipData("野蛮人","战杖","elemental_damage_+%",20,2)                   -- 元素伤害
...
-- 魔力相关
SetAtuoChangeEquipData("野蛮人","战杖|项链","base_maximum_mana",15,2)                -- 最大魔力
SetAtuoChangeEquipData("野蛮人","战杖|项链","base_mana_regeneration_rate_per_minute",12,2) -- 魔力回复
...
SetZhengTiColorVarData(2,0,0,0,nil,50,true)
...
SetZhengTiColorVarData(3,0,0,0,nil,50,true)
...
SetZhengTiColorVarData(4,0,0,0,nil,50,true)
...
SetZhengTiColorVarData(5,0,0,0,nil,50,true)
...
SetZhengTiColorVarData(9,0,0,0,nil,50,true)
...
SetZhengTiColorVarData(10,0,0,0,nil,50,true)
...
-- 階段2: 12級開始 強制使用 战杖 (配合召喚技能)
-- 分數給 2000，確保轉型後只拿战杖，不拿斧劍
SetGaoJiHuanZhuangData("野蛮人", nil, "战杖", nil, nil, nil, nil, nil, 3, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, 2000, nil, 12, nil)

-- 階段3: 12級以上，如果有 "3連的战杖"，額外加分 (優化)
-- 這樣既限制了必須是战杖，又鼓勵拿多孔的
SetGaoJiHuanZhuangData("野蛮人", nil, "战杖", nil, nil, 3, 15, nil, 3, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, 3000, nil, 13, nil)
