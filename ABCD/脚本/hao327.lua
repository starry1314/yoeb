...
-- SetNotUseMapLv(60,15)--80级打15阶级及以下的图
...
SetNeedAddTianFu("野蛮人升华=AscendancyBerserker3-物理傷害，近戰打擊範圍|AscendancyBerserker10-先祖之怒|AscendancyBerserker4-物理傷害、擊中獲得盛怒機率|AscendancyBerserker11-屠戮之慾|AscendancyBerserker5-物理傷害、擊中獲得盛怒機率|AscendancyBerserker8-毀滅儀式|AscendancyBerserker13-物理傷害，攻擊速度|AscendancyBerserker12-血肉之章|")
